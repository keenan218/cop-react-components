...
<Canvas>
  <Story name='Standard'>
    <FormGroup
      ...
      hint='For example, 27 3 2007'
    >
      <DateInput id='standard' name='standard' />
    </FormGroup>
  </Story>
</Canvas>
  ...
  <Story name='DateInputError'>
    {() => {
      return (
        ...
        >
          <DateInput id='dateinput' name='dateinput' day={6} month={3} year={2076} error={{"year" : true, "month" : true, "day" : true}} />
        </FormGroup>
      );
    }}
  </Story>
  ...
  <Story name='DateInputMissingYear'>
    {() => {
      return (
        ...
        >
          <DateInput id='dateinput' name='dateinput' day={6} month={3} error={{"year" : true}} />
        </FormGroup>
      );
    }}
  </Story>
